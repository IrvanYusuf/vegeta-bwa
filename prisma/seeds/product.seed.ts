...
const main = async () => {
  ...
  const data: Prisma.ProductCreateInput[] = [
    {
      name: "Wortel",
      image: "/assets/products/wortel.jpeg",
    ...
    {
      name: "Jagung",
      image: "/assets/products/jagung.jpeg",
      category: ProductCategory.VEGETABLE,
      description:
    ...
    {
      name: "Semangka",
      image: "/assets/products/semangka.jpeg",
    ...
    {
      name: "Jahe",
      image: "/assets/products/jahe.jpeg",
    ...
    {
      name: "Kacang Tanah",
      image: "/assets/products/kacang.jpeg",
    ...
    {
      name: "Jamur Kancing",
      image: "/assets/products/jamur.png",
    ...
    {
      name: "Buah Naga",
      image: "/assets/products/buah naga.png",
      category: ProductCategory.FRUIT,
      description:
    ...
    {
      name: "Sawi",
      image: "/assets/products/sawi.jpeg",
      category: ProductCategory.FRUIT,
      description:
    ...
    {
      name: "Bayam Merah",
      image: "/assets/products/bayam.jpeg",
      category: ProductCategory.VEGETABLE,
      description:
    ...
    {
      name: "Daung Bawang",
      image: "/assets/products/daun bawang.jpeg",
      category: ProductCategory.VEGETABLE,
      description:
